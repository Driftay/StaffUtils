...
public class StaffModeCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (plugin.getConfig().getBoolean("STAFFMODE.items.compass.enabled")) {
        ...
        if (plugin.getConfig().getBoolean("STAFFMODE.items.randomtp.enabled")) {
            ItemStack RandomTP;
            if (plugin.ver > 113) {
        ...
        if (plugin.getConfig().getBoolean("STAFFMODE.items.invseebook.enabled")) {
        ...
        if (plugin.getConfig().getBoolean("STAFFMODE.items.freezetool.enabled")) {
        ...
        if (plugin.getConfig().getBoolean("STAFFMODE.items.stafflist.enabled")) {
            ItemStack stafflist;
            if (plugin.ver > 113) {
        ...
        if (plugin.getConfig().getBoolean("STAFFMODE.items.vanish.enabled")) {
            ItemStack vanish;
            if (plugin.ver > 113) {
        ...
        if (plugin.getConfig().getBoolean("STAFFMODE.items.wand.enabled")) {
            ItemStack vanish;
            if (plugin.ver > 113) {
