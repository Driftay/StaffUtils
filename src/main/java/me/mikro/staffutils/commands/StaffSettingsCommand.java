...
public class StaffSettingsCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (plugin.getConfig().getBoolean("STAFFSETTINGS.fill_with_glass")) {
            ItemStack glass;
            if (plugin.ver > 113) {
        ...
        if (plugin.data.get(player.getUniqueId()).getConfig().getBoolean("staff.staffchat_on_join")) {
            ItemStack staffchat;
            if (plugin.ver > 113) {
        ...
        if (plugin.data.get(player.getUniqueId()).getConfig().getBoolean("staff.vanish_view_others")) {
